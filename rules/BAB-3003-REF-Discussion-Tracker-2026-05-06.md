...
`next_d` = **D5** (next new topic gets D5)
...
- Continue from approved `BAB-2218`; save the M3 planning/contract docs in PR,
  then begin Phase 7 implementation CHG/TDD planning.
