...
- Remaining operational prerequisite: Playwright is configured to use local
  Google Chrome. If a future CI environment lacks Chrome, install Playwright's
  managed browser binaries or configure an available browser channel there.
